        ...
        <div class="row">
            ...
            <div class="col-10 pt-3 px-4 border-start">
                ...
                <div class="table-responsive text-center">
                    <form action="${path}/categoryModifyProAdmin.do" method="post">
                        <input type="hidden" name="par" id="par" value="${category.par }">
                        <table class="table table-striped-columns table-sm">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="cateno" id="cateno" value="${category.cateno}" class="form-control" readonly></td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="cname" class="form-label">카테고리명</label></th>
                                <td><input type="text" name="cname" id="cname" value="${category.cname}" class="form-control" required></td>
                            </tr>
                            </tbody>
                        </table>
                        <div class="btn_group txt_right">
                            <a href="${path}/categoryListAdmin.do?type=${category.par }" class="inBtn">목록</a>
                            <button type="submit" class="inBtn inBtn2">수정</button>
                        </div>
                    </form>
                </div>
            </div>
