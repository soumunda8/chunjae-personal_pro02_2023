    ...
    <div class="row">
        ...
        <div class="col-10 pt-3 px-4 border-start">
            ...
            <div class="table-responsive text-center">
                <form action="${path}/modifyProductPro.do" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped-columns table-sm">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="pname" id="pname" class="form-control" placeholder="상품명 입력" value="${product.pname }" maxlength="90" required></td>
                        </tr>
                        <tr>
                                ...
                                <div class="form-row">
                                    <select name="cateno" id="cateno" class="form-control">
                                        ...
                                        <c:forEach items="${categoryList }" var="category" varStatus="status">
                                            <option value="${category.cateno}" <c:if test="${product.cateno eq category.cateno }">selected</c:if>>${category.cname}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="price" id="price"  placeholder="상품 가격 입력" class="form-control"  value="${product.price }" min="1000" step="100" required>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="pcomment" class="form-label">상품설명</label></th>
                            <td>
                                <textarea rows="10" cols="100" name="pcomment" id="pcomment" placeholder="상품의 자세한 정보를 입력하세요" class="form-control" maxlength="1990" required>${product.pcomment }</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="plist" class="form-label">상품목차</label></th>
                            <td>
                                <textarea rows="10" cols="100" name="plist" id="plist" placeholder="도서 상품의 목차를 입력하세요" class="form-control" maxlength="1990" required>${product.plist }</textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="file" name="thumbnail" id="thumbnail" placeholder="상품 메인이미지" class="form-control">
                                <input type="hidden" name="uploadThumbnail" id="uploadThumbnail" value="${product.thumbnail}">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="videosub" class="form-label">맛보기영상</label></th>
                            <td>
                                <video id="video" style="max-width:300px">
                                ...
                                <input type="hidden" name="uploadVideo" id="uploadVideo" value="${product.videosub}">
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    <div class="btn_group txt_right">
                        <button type="submit" class="inBtn">수정</button>
                        <a href="${path }/productGetAdmin.do?prono=${product.prono }" class="inBtn inBtn2">취소</a>
                    </div>
                </form>
            </div>
        </div>
