...
<div class="contents sub01">
    ...
    <div class="sub_content pb-5">
        ...
        <div class="container product_area">
            <h3 class="text-center fs-1 my-5">공지사항 등록</h3>
            <div class="page mb-5">
                <form action="${path }/addBoardPro.do" method="post">
                    <input type="hidden" name="boardType" value="0010">
                    <table class="table">
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea class="form-control" id="content" name="content" rows="5" required></textarea></td>
                        </tr>
                        </tbody>
                    </table>
